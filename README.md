...
| Tab | Open dedicated completion; search snippet keyword prefixes, otherwise use normal completion. Press Tab again in the snippet picker for normal completion |
